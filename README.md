...
Update
----
* 2026.08.29 支持世界模型，暂时未量化，直接使用官方原始模型推理, support world model, not quantized, use official model to infer;
...
Echo-WM dit :[JoyAI-Echo-wm ](https://huggingface.co/Echo-Team/Echo-WM)  
...
├── ComfyUI/models/vae/
|     ├── ltx-2.3-22b-distilled_video_vae.safetensors #Echo-WM don't need
|     ├── ltx-2.3-22b-distilled_audio_vae.safetensors #Echo-WM don't need
├── ComfyUI/models/gguf/
...
4 Example
----
![](https://github.com/smthemex/ComfyUI_JoyAI_Echo/blob/main/example_workflows/example-wm.png)
